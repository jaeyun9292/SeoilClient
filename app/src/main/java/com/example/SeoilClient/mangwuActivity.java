...
public class mangwuActivity extends AppCompatActivity implements OnMapReadyCallback,
        ActivityCompat.OnRequestPermissionsResultCallback {

    private Marker currentMarker = null;
    private Marker mang1Marker = null;
    private Marker mang2Marker = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mangwu);
        mLayout = findViewById(R.id.xml_mangwu);
...
//        btn_baecha.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                Intent intent = new Intent(getApplicationContext(),mangwubaechaActivity.class);
...
//        });
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap = googleMap;
        mang = new LatLng(37.592972,127.093406); //망우역 위치
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(mang,15));//카메라 옮기기
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, REQUIRED_PERMISSIONS[0])) {
                ...
                Snackbar.make(mLayout, "이 앱을 실행하려면 위치 접근 권한이 필요합니다.",
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityCompat.requestPermissions( mangwuActivity.this, REQUIRED_PERMISSIONS,
    ...
    LocationCallback locationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            if (locationList.size() > 0) {
                ...
                try {
                    String result;
                    mangwuActivity.CustomTask2 task = new mangwuActivity.CustomTask2();
                    result = task.execute("mangwoo").get();
                    ...
                    if (mang1Marker != null) mang1Marker.remove();
                    if (mang2Marker != null) mang2Marker.remove();


                    mang1 = new LatLng(Float.valueOf(position[0]).floatValue(),Float.valueOf(position[1]).floatValue());//mang1에 위치저장
                    mo1.icon(BitmapDescriptorFactory.fromResource(R.drawable.mang_1));
                    mang1Marker = mMap.addMarker(mo1.position(mang1).title("망우1"));


                    mang2 = new LatLng(Float.valueOf(position[2]).floatValue(),Float.valueOf(position[3]).floatValue());//mang2에 위치저장
                    mo2.icon(BitmapDescriptorFactory.fromResource(R.drawable.mang_2));
                    mang2Marker = mMap.addMarker(mo2.position(mang2).title("망우2"));
...
//        currentMarker = mMap.addMarker(markerOptions);
    ...
    private void showDialogForLocationServiceSetting() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(mangwuActivity.this);
